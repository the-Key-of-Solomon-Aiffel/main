...
_URL = "https://aihub.or.kr/aihubdata/data/view.do?currMenu=115&topMenu=100&aihubDataSe=realm&dataSetSn=93"
...
TRAINING_FPATH_REL = "./도서자료 요약/Training/[원천]도서요약_train.zip"
VALIDATION_FPATH_REL = "./도서자료 요약/Validation/[원천]도서요약_valid.zip"
...
class AIHubBookSummarization(datasets.GeneratorBasedBuilder):
    """AIHubBookSummarization Dataset"""

    BUILDER_CONFIGS = [
        datasets.BuilderConfig(
            name="base",
            version=_VERSION,
            description="AIHub Book Summarization Dataset",
        )
    ]
    ...
    via 'datasets.load_dataset("aihub_book_summarization.py", data_dir="<path/to/folder>")'
    """)
