...
LAW_TRAINING_FPATH_REL = "문서요약 텍스트/Training/법률_train_original.zip"
MAG_TRAINING_FPATH_REL = "문서요약 텍스트/Training/사설_train_original.zip"
NEWS_TRAINING_FPATH_REL = "문서요약 텍스트/Training/신문기사_train_original.zip"

LAW_VALIDATION_FPATH_REL = "문서요약 텍스트/Validation/법률_vaild_original.zip"
MAG_VALIDATION_FPATH_REL = "문서요약 텍스트/Validation/사설_vaild_original.zip"
NEWS_VALIDATION_FPATH_REL = "문서요약 텍스트/Validation/신문기사_vaild_original.zip"
